...
func TestNewBuilder(t *testing.T) {
	...
	empty := builder.Build()
	assert.Equal(t, event.ID("a1c11a53-c4be-488f-89b6-f83bf2d48dab"), empty.ID())
	assert.Equal(t, event.Type("com.example.test"), empty.Type())
	...
	assert.Equal(t, event.ID("a1c11a53-c4be-488f-89b6-f83bf2d48dab"), empty.ID())
	assert.Equal(t, event.Type("com.example.test"), withRecipient.Type())
	...
	assert.Equal(t, event.ID("a1c11a53-c4be-488f-89b6-f83bf2d48dab"), empty.ID())
	assert.Equal(t, event.Type("com.example.test"), withDefaultMessage.Type())
	assert.Len(t, withRecipient.Recipient().ToList(), 1)
	...
	assert.Equal(t, event.ID("a1c11a53-c4be-488f-89b6-f83bf2d48dab"), empty.ID())
	assert.Equal(t, event.Type("com.example.test"), withMessageForTransport.Type())
	assert.Len(t, withRecipient.Recipient().ToList(), 1)
	...
	assert.Equal(t, event.ID("a1c11a53-c4be-488f-89b6-f83bf2d48dab"), empty.ID())
	assert.Equal(t, event.Type("com.example.test"), withSlackOpts.Type())
	assert.Len(t, withRecipient.Recipient().ToList(), 1)
